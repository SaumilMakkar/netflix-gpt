  ...
  return (
    <div>
        ...
        <h1 className='font-bold text-3xl pb-4'>{isSignInForm?"Sign In":"Sign Up"}</h1>
          <input type='text' placeholder='Email Address' className='p-2 my-2 w-full bg-gray-670'/>
                    {!isSignInForm&&
                      


                      <input type='text' placeholder='Full Name' className='p-2 my-2 w-full bg-gray-670'/>}
          <input type='password' placeholder='Password' className='p-2 my-2 w-full bg=gray-670'/>
